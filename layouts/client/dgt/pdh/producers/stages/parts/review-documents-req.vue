      ...
      <FormSection :title="$t('Missing Documents')">
        <template v-slot:body>
          <div class="mt-6 mx-6 body-1 text-justify unselectable">
            ...
            essenciais para a registo da mera comunicação prévia. Certifique-se que a
            lista seguinte não contém nenhum documento marcado como obrigatório.
          </div>
...
export default {
  ...
  methods: {
    ...
    loadDocuments: async function (record) {
      ...
      this.documentsMissing = this.correctMissing(submitted, missing);//missing;
