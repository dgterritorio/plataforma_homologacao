...
export default {
  ...
  data() {
    return {
      description:
        "<p>Após a análise prévia do processo, foi aferido que o processo não se encontra bem instruído. </p>" +
        "<p> Deve seguir as instruções na secção de observações e voltar a submeter os dados necessários listados na tabela de tarefas.</p>",
