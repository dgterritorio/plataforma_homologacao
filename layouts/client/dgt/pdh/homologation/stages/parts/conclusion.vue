  ...
  <v-row style="margin:0;">
      ...
      <FormSection :title="$t('State Transition Forecast')">
        <template v-slot:body>
          <div class="mt-6 mx-6 body-1  text-justify unselectable">
            Nesta secção encontram-se (à esquerda) o estado atual da tramitação e (à direita)
          ...
          <v-row class="mx-3">
            <v-col :offset="1" :sm="4" :md="4" :lg="4" class="d-flex flex-column align-center justify-center">
              <!-- State -->
              <div
            ...
            <v-col :sm="4" :md="4" :lg="4" class="d-flex flex-column align-center justify-center">
              <!-- State -->
              <div
                class="font-weight-medium  body-1 text-justify unselectable"
                style="text-align: center !important"
    ...
    <v-col :sm="12" :md="12" :lg="12">
      ...
      <FormSection :title="$t('Tasks Summary')">
        <template v-slot:body>
          <div class="mt-6 mx-6 body-1  text-justify unselectable">
            Na lista seguinte encontra-se o resumo de cada tarefa cumprida para o estado atual da tramitação.
            Consoante a conclusão da tarefa, a tramitação pode transitar para o estado seguinte ou para um ciclo de
            correção de dados.
          </div>
    ...
    <v-col :sm="12" :md="12" :lg="12">
      ...
      <FormSection :title="$t('Relevant Observations')">
        <template v-slot:body>
          ...
          >Deve preencher observações relevantes a transmitir ao próximo interveniente na tramitação da homologação.</div>
