...
export default {
  ...
  computed: {
    shorttext: function () {
      return this.record.vectorial ? "V" : "I";
    },

    text: function () {
      return this.record.vectorial
        ? "Cartografia Vetorial"
        : "Cartografia de Imagem";
    },

    color: function () {
      return "primary"; //this.record.vectorial ? "red" : "primary";
    },
    icon: function () {
      return this.record.vectorial ? "mdi-vector-polygon" : "mdi-image";
    },
  },
};
</script>
