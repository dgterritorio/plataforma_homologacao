...
export default class Requests extends BaseModel {
  ...
  static entity = 'HomologationRequests'
  ...
  static fields() {
    return {
      ...
      has_themes: this.boolean(false),
      metacontrol: this.boolean(false),
      protocol: this.boolean(false),
      purpose: this.number(),
      ...
      data_specification_version: this.number().nullable(),
      ...
      show_evaluator: this.boolean(false),
      ...
      conclusion_date: this.string('', this.justDate).nullable(),
      flight_date: this.string('', this.justDate).nullable(),
  ...
  get flight_date_str() {
    return this.flight_date ? this.flight_date : 'Sem data';
  }

  get conclusion_date_str() {
    return this.conclusion_date ? this.conclusion_date : 'Sem data';
  }
