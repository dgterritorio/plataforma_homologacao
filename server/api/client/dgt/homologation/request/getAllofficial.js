...
async function getRequestInfo(params) {
    ...
    let head = 'select id, name, vectorial, start_date, end_date, product_type, county, applicant_id, applicant_name, epsg, data_type, data_specification, producers_list, owner_name ',
        body = ' from homologation.official_requests ',
        where = '';
