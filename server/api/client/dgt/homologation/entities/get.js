...
async function getRequestInfo(params) {
    ...
    let sql = "select * from homologation.entities he inner join producers.entities pe on pe.id = he.producer_id where he.request_id = " + params.requestId + ";";
...
export default async function (req, res, next) {
    console.log("> Request: Get entities");
    try {
        const body = req.body;
