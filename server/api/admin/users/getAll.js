...
async function getRequestInfo(params) {
    let head = "select id, email, name, group_id, creation_date, mod_date, active, confirmed";
    head += ", '' as password, empresas ";
    let body = "from webapp.usermemberships_view";
...
export default async function (req, res, next) {
    console.log("> Request: Get Admin Users");
    try {
        const body = req.body;
